                    ...
                    <div class="content05-main">
                        <div class="content05-main-inner">
                            <table class="table content05-table hidden-xs">
                               ...
                               foreach ($subject_list as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td class=""><?php echo $row['subject_name']?></td>
                                        <td style="border: none; background-color: white;" class="border-action"><a href="<?php echo site_url('admin/edit-subject/'.$row['id'])?>"><button class="edit-table">編集</button></a></td>
                                                    ...
                                                    <div class="w3-container">
                                                        <div class="w3-right">
                                                            <p>
                                                                ...
                                                                <a href="<?php echo site_url('admin/subject/delete/'.$row['id'])?>"><button class="w3-btn w3-red w3-border">Delete</button></a>
                                                        </div>
                                                        </p>
                                                    </div>
                                                    <br/>
                            ...
                            <div class="register-button hidden-xs">
                                <a href="<?php echo site_url('admin/create-subject')?>">
                                    ...
                                    <table class="table visible-xs">
                                        ...
                                        foreach ($subject_list as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%" class=""><?php echo $row['subject_code'] ?></td>
                                            </tr>
                                            <tr>
                                                <td class="">乗車場所</td>
                                                <td class=""><?php echo $row['subject_name']?></td>
                                            ...
                                            <tr>
                                                <td colspan="2" class="">
                                                    <a href="<?php echo site_url('admin/edit-subject/'.$row['id'])?>">
