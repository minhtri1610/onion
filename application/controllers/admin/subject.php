    ...
    public function edit($id = NULL) {
        ...
        try {
            ...
            if ($this->input->post())
            {
                ...
                {
                    $this->session->set_flashdata('message', "<div class='alert-danger'>Update fail! Subject code already exists</div>");
        ...
        try {
            ...
            if ($this->input->post()) {
                ...
                if ($this->form_validation->run() == true) {
                    ...
                    $this->subject->insert($dataUpdate);
                    $this->session->set_flashdata('message', "<div class='alert-success'>Inserted !</div>");
                    redirect('admin/create-subject');
                }
                else if ($this->form_validation->run() == false)
                {
                    $this->session->set_flashdata('message', "<div class='alert-danger'>Insert fail! Subject code already exists</div>");
                    redirect('admin/create-subject');
                }
            }
